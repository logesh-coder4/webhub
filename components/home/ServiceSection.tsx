...
const ServiceCard=({name,description,icon:Icon}:ServiceType)=>{
    return(
        <motion.div>
            <Card className="max-w-md hover:border-l-2 bg-transparent hover:border-l-zinc-900 dark:hover:border-l-zinc-400">
...
const ServiceSection = () => {
  ...
  return (
    <div className="w-full  py-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 space-y-1 gap-4 p-4 my-4">
